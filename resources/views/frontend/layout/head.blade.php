<!-- Page Title -->
<title>@yield('title') | Rajkot Mahajan Panjrapole</title>
...
<link rel="icon" type="image/png" sizes="16x16" href="{{ url('public/assets/images/logo/favicon-16x16.png') }}">
...
<!-- CSS | Theme Color -->
<link href="{{ url('public/assets/css/colors/theme-skin-orange.css') }}" rel="stylesheet" type="text/css">
<style>
  p{
    text-align: justify;
  }
