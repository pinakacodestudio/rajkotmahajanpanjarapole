        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="row">
            <div class="col-lg-4 img-hover-border mt-sm-30">
                <img class="img-fullwidth" src="{{ url('public/assets/images/about/about-1.jpg') }}" alt="">
            </div>
            <div class="col-lg-8">
          ...
          <div class="row" style="margin-top: -15px;">
            ...
            <div class="col-lg-4 img-hover-border mt-sm-30">
                <img class="img-fullwidth" src="{{ url('public/assets/images/about/about-2.jpg') }}" alt="">
            </div>
          </div>
    ...
    <section class="container">
      <div class="row pt-10 pl-10 pr-10" id="terms-conditions">
        <div class="col-lg-12 col-md-12">
          ...
          <div class="row">
            <div class="col-lg-4 img-hover-border mt-sm-30">
                <img class="img-fullwidth" src="{{ url('public/assets/images/about/about-4.jpg') }}" alt="">
            </div>
            <div class="col-lg-8">
              <ul class="list theme-colored check">
              <li class="text-justify">
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="row" style="margin-top: -15px;">
            <div class="col-lg-12">
              ...
              <div class="col-lg-4 img-hover-border mt-sm-30">
                <img class="img-fullwidth" src="{{ url('public/assets/images/about/about-5.jpg') }}" alt="">
            </div>
            </div>
          </div>
        </div>
                    ...
                    <div class="team-slider owl-carousel">
                      ...
                      <div class="team-member clearfix">
                        <div class="team-thumb">
                          <img alt="" src="{{ url('public/assets/images/Certificates/certificate-1.jpg') }}" class="img-fullwidth">
                        </div>
                      ...
                      <div class="team-member clearfix">
                        <div class="team-thumb">
                          <img alt="" src="{{ url('public/assets/images/Certificates/certificate-2.jpg') }}" class="img-fullwidth">
                        </div>
                        <div class="team-info bg-theme-colored">
                          <p class="mt-5 text-center text-white font-20" style="line-height:1.4rem">Certificate Name</p>
                        </div>
                      ...
                      <div class="team-member clearfix">
                        <div class="team-thumb">
                          <img alt="" src="{{ url('public/assets/images/Certificates/certificate-3.jpg') }}" class="img-fullwidth">
                        </div>
                        <div class="team-info bg-theme-colored">
                          <p class="mt-5 text-center text-white font-20" style="line-height:1.4rem">Certificate Name</p>
                        </div>
                      ...
                      <div class="team-member clearfix">
                        <div class="team-thumb">
                          <img alt="" src="{{ url('public/assets/images/Certificates/certificate-4.jpg') }}" class="img-fullwidth">
                        </div>
                        <div class="team-info bg-theme-colored">
                          <p class="mt-5 text-center text-white font-20" style="line-height:1.4rem">Certificate Name</p>
                        </div>
